...
def module_attrs(attrs: Dict[str, tvm_Object]) -> None:
    ...
    attrs: Dict[str, Object]
        The module attrs.
    """
    return _ffi_api.ModuleAttrs(attrs)  # pylint: disable=no-member # type: ignore
...
def module_global_infos(global_infos: Dict[str, List[GlobalInfo]]) -> None:
    ...
    """
    return _ffi_api.ModuleGlobalInfos(global_infos)  # pylint: disable=no-member # type: ignore
